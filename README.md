# azure-cli-with-docker [![Build Status](https://travis-ci.org/Streeva/azure-cli-with-docker.svg?branch=master)](https://travis-ci.org/Streeva/azure-cli-with-docker)
